namespace WebServer.TemplateEngine
{
    ...
    public interface ITemplateGenerator
    {
        ...
        /// <exception cref="Exceptions.CodeGeneratorException">If template is incorrect</exception>
        ...
        /// <exception cref="Exceptions.CodeGeneratorException">If something is incorrect in the template.</exception>
