namespace WebServer.Resources
{
    ...
    /// </summary>
    public class FileResourcesLoader : IResourceLoader
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileResourcesLoader"/> class.
        /// </summary>
        public FileResourcesLoader()
        {
        ...
        /// </code>
        /// </example>
        public FileResourcesLoader(string uri, string absolutePath)
        {
            ForbiddenCharacters = DefaultForbiddenChars;
